...
def create_model():
    ...
    layer6 = Conv2D(512, (2, 2))(layer6) #12, 12, 512
    layer6 = BatchNormalization()(layer6)
    layer6 = LeakyReLU(alpha=.1)(layer6)

    decoder5 = Conv2DTranspose(256, (3, 3), strides=(2,2))(layer6) #25, 25, 256
    layer5 = backbone.get_layer('conv4_block5_out').output #25, 25, 1024
    layer5 = res_block(layer5, 256) #25, 25, 256
    decoder5 = Concatenate()([decoder5, layer5]) #25, 25, 512
    decoder5 = Dropout(.2)(decoder5)
    ...
    layer2 = res_block(layer2, 32) #200, 200, 32
